...
$update_tpms = "";
$delete_tpms = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '15' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_tpms = $roww["xcreate"];
        $read_tpms   = $roww["xread"];
        $update_tpms = $roww["xupdate"];
        $delete_tpms = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/pms/v_pms.php"; ?>
            </div>
