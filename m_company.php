...
else
{
    ...
    {
        $create_mcompany = $roww["xcreate"];
        $read_mcompany   = $roww["xread"];
        $update_mcompany = $roww["xupdate"];
        $delete_mcompany = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/company/v_company.php"; ?>
            </div>
