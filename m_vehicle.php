...
$delete_mvehicle = "";
$update_mvehicle = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '11' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mvehicle = $roww["xcreate"];
        $read_mvehicle   = $roww["xread"];
        $update_mvehicle = $roww["xupdate"];
        $delete_mvehicle = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/vehicle/v_vehicle.php"; ?>
            </div>
