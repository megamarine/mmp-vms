...
else
{
    ...
    {
        $create_mpurpose = $roww["xcreate"];
        $read_mpurpose   = $roww["xread"];
        $update_mpurpose = $roww["xupdate"];
        $delete_mpurpose = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/purpose/v_purpose.php"; ?>
            </div>
