...
else
{
    if(isset($_GET["KODE"]))
    {
        ...
        InsertData(
            ...
            "'', 'Hapus Department - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");

        ?>
        <script>alert('Department has been deleted! Thank you! ');</script>
        <script>document.location.href='m_department.php';</script>
        <?php
        die(0);
    }
}
