...
else
{
    if(isset($_GET["KODE"]))
    {
        ...
        InsertData(
            ...
            "'', 'Hapus Purpose - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");

        ?>
        <script>alert('Purpose has been deleted! Thank you! ');</script>
        <script>document.location.href='m_purpose.php';</script>
        <?php
        die(0);
    }
}
