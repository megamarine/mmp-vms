...
else
{
    ...
    {
        $create_mdivision = $roww["xcreate"];
        $read_mdivision   = $roww["xread"];
        $update_mdivision = $roww["xupdate"];
        $delete_mdivision = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/division/v_division.php"; ?>
            </div>
