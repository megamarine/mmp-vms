...
else
{
    ...
    {
        $create_mvisitortype = $roww["xcreate"];
        $read_mvisitortype   = $roww["xread"];
        $update_mvisitortype = $roww["xupdate"];
        $delete_mvisitortype = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/visitortype/v_visitortype.php"; ?>
            </div>
