...
else
{
    if(isset($_GET["KODE"]))
    {
        ...
        InsertData(
            ...
            "'', 'Hapus Visitor Type - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");

        ?>
        <script>alert('Visitor Type has been deleted! Thank you! ');</script>
        <script>document.location.href='m_visitortype.php';</script>
        <?php
        die(0);
    }
}
