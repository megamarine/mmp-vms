...
else
{
    if(isset($_GET["KODE"]))
    {
        ...
        InsertData(
            ...
            "'', 'Hapus Company Type - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");

        ?>
        <script>alert('Company has been deleted! Thank you! ');</script>
        <script>document.location.href='m_companytype.php';</script>
        <?php
        die(0);
    }
}
