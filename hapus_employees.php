...
else
{
    if(isset($_GET["KODE"]))
    {
        ...
        InsertData(
            ...
            "'', 'Hapus Employees - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");

        ?>
        <script>alert('Employees has been deleted! Thank you! ');</script>
        <script>document.location.href='m_employees.php';</script>
        <?php
        die(0);
    }
}
