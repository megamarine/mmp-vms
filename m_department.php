...
else
{
    ...
    {
        $create_mdepartment = $roww["xcreate"];
        $read_mdepartment   = $roww["xread"];
        $update_mdepartment = $roww["xupdate"];
        $delete_mdepartment = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/department/v_department.php"; ?>
            </div>
