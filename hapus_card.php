...
else
{
    if(isset($_GET["KODE"]))
    {
        ...
        InsertData(
            ...
            "'', 'Hapus Card - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");

        ?>
        <script>alert('Card has been deleted! Thank you! ');</script>
        <script>document.location.href='m_card.php';</script>
        <?php
        die(0);
    }
}
