...
else
{
    ...
    {
        $create_mcompanytype = $roww["xcreate"];
        $read_mcompanytype   = $roww["xread"];
        $update_mcompanytype = $roww["xupdate"];
        $delete_mcompanytype = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/companytype/v_companytype.php"; ?>
            </div>
