...
<div class="page-header page-header-block">
    <div class="page-header-section">
        <h4 class="title semibold"><i class="fas fa-balance-scale"></i> Edit Unit Measurement</h4>
    </div>
    <div class="page-header-section">
        <div class="toolbar">
            <ol class="breadcrumb breadcrumb-transparent nm">
                ...
                <li class="active"><i class="fas fa-edit"></i> Edit Unit Measurement</li>
            </ol>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" autocomplete="off" id="UM_DESC" name="UM_DESC" value="<?php echo $UM_DESC; ?>" data-parsley-required>
                    </div>                          
                </div>
                <div class="col-md-4">
                    <div class="form-group">
