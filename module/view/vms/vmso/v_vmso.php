...
$stmt  = GetQuery("SELECT a.*,
                ...
                LEFT JOIN m_um f ON a.um_id = f.um_id
                     JOIN m_user g ON a.created_by = g.kode_user
                    WHERE a.state='1' AND a.status_visitor='1' AND a.status_hapus='0' AND a.vehicle_no IS NOT NULL 
                    ORDER BY a.created_date DESC, a.vms_id DESC");
?>
<div class="page-header page-header-block">
    <div class="page-header-section">
        <h4 class="title semibold"><i class="fas fa-people-arrows"></i> Visitor Management System - Outside Area</h4>
    </div>
    <div class="page-header-section">
        <div class="toolbar">
            <ol class="breadcrumb breadcrumb-transparent nm">
                <li><a href="menuutama"><i class="ico-home2"></i> Dashboard</a></li>
                <li class="active"><i class="fas fa-expand-alt"></i> VMS - Outside Area</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-4">
        <div class="btn-group btn-group-justified" role="group" aria-label="...">
          <div class="btn-group" role="group">
            <a href="vmso_pre" class="btn btn-secondary">Pre Register <i class="fas fa-list-ol fa-lg"></i></a>
          </div>
        </div>
        <br>
        <div class="btn-group btn-group-justified" role="group" aria-label="...">
          <div class="btn-group" role="group">
            <a href="vmso_in" class="btn btn-primary">Check In <i class="fas fa-sign-in-alt"></i></a>
          </div>
          <div class="btn-group" role="group">
            <a href="vmso_out" class="btn btn-danger">Check Out <i class="fas fa-sign-out-alt"></i></a>
          </div>
        </div>
    </div>
    <div class="col-lg-4">
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) 
                    {
                        ...
                        <tr>
                            ...
                            <?php 
                                if($row["vehicle_no"] != "") {
                            ?>
                                    <td align="center"><a href="print_vms?KODE_TAMU=<?php echo $row["vms_id"]; ?>" target="_blank" title="Print Visitor Pass" class="btn btn-primary mb5"><i class="fas fa-print"></i></a></td>
                            <?php
                                }
                                else {
                                    echo "<td></td>";
...
$(document).on("click", ".open-detail", function ()
{
    ...
    $(".modal-body #visitortype_name").html( $(this).data('visitortype_name'));
    $(".modal-body #visitortype_name").html( $(this).data('visitortype_name'));
