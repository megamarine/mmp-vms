...
<div class="page-header page-header-block">
    <div class="page-header-section">
        <h4 class="title semibold"><i class="fas fa-city"></i> Add Company Type</h4>
    </div>
    <div class="page-header-section">
        <div class="toolbar">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="" autocomplete="off" id="COMPANYTYPE_NAME" name="COMPANYTYPE_NAME" data-parsley-required>
                    </div>                          
                </div> 
            </div>
            <br><br>
