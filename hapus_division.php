...
else
{
    if(isset($_GET["KODE"]))
    {
        ...
        InsertData(
            ...
            "'', 'Hapus Division - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");

        ?>
        <script>alert('Division has been deleted! Thank you! ');</script>
        <script>document.location.href='m_division.php';</script>
        <?php
        die(0);
    }
}
