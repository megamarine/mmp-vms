...
<html class="backend">
    ...
    <body style="background-color:#293e63">
        <div class="wrapper fadeInDown">
            <!-- <a class="btn btn-danger" href="manual book/WHAT-NEWS.pdf" target="_blank"><span class="icon"><i class="ico-info"></i></span> Klik disini untuk melihat apa yang baru pada VMS</a><br> -->
            <div id="formContent"><br>
                <h3 class="active"> <strong>Visitor Management System</strong> </h3>
                <div class="fadeIn first">
                  <img src="assets/assets/mmp.png" width="40%">
                </div><br>
                <form method="post">
